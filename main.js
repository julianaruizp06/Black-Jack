...
function operacionReiniciar(tiempo) {
  ...
  /* turno crupier
  se genera el array con las cartas del Crupier
  se controla el valor del As
  se suma los valore del array */
  var sumaRefe = 0;
  let cartaCrup = [];
  ...
  //funcion para verificar la suma del jugador
  ...
  //funcion para verificar la suma del crup
  ...
  //funcion para generar las cartas en el dom del crup
